...
enum L10n {
    ...
    private static let simplified: [Key: String] = [
        ...
        .deleteMessageHint: "此消息将被永久删除。",
        .confirmDeleteConversation: "此操作无法撤销，确定要删除这个对话吗？",
        .rename: "重命名",
        .renameHint: "输入新名称",
        .save: "保存",
        .cancel: "取消",
        ...
        .onboardingDataBody: "对话、索引和分析档案保存在本地，但依赖模型的功能会把所需上下文和相关数据发送到你选择的模型 API。",
        ...
        .dataPrivacyDesc: "对话、索引和分析档案保存在本地；使用模型时，所需上下文和相关数据会发送给 DeepSeek API。",
        ...
        .enableLogging: "调试日志",
        .loggingHint: "将运行日志写入数据目录下的 prism.log",
        .exportLogs: "导出日志",
        .exportLogsHint: "将当前 prism.log 另存为文件，便于排查问题",
        .validate: "验证",
        .validating: "验证中…",
        .validationSuccess: "✓ 密钥有效",
        .validationFailed: "密钥验证失败",
        .validationFailedHint: "可以稍后在设置中修改，或直接继续",
        .memoryTimeline: "叙事时间轴",
        .memoryStarted: "对话发起",
        .memoryFirstMessage: "第一条消息",
        .memoryLatestMessage: "最近消息",
        .memoryElapsed: "已跨时长",
        .modelUsage: "模型用量",
    ...
    private static let traditional: [Key: String] = [
        ...
        .deleteMessageHint: "此訊息將被永久刪除。",
        .confirmDeleteConversation: "此操作無法撤銷，確定要刪除這個對話嗎？",
        .rename: "重新命名",
        .renameHint: "輸入新名稱",
        .save: "儲存",
        .cancel: "取消",
        ...
        .onboardingWelcomeBody: "稜鏡是基於 DeepSeek 的敘事分析 Agent。它識別你的敘事模式、追蹤情緒變化、發現盲點。",
        .onboardingPurposeTitle: "稜鏡能做什麼",
        .onboardingPurposeBody: "稜鏡基於 DeepSeek 大語言模型，透過對話幫你梳理敘事中的事實、解釋、情緒和未知資訊。",
        .onboardingFeaturesTitle: "核心特性",
        ...
        .enableLogging: "調試日誌",
        .loggingHint: "將運行日誌寫入數據目錄下的 prism.log",
        .exportLogs: "匯出日誌",
        .exportLogsHint: "將目前 prism.log 另存為檔案，方便排查問題",
        .validate: "驗證",
        .validating: "驗證中…",
        .validationSuccess: "✓ 密鑰有效",
        .validationFailed: "密鑰驗證失敗",
        .validationFailedHint: "可以稍後在設定中修改，或直接繼續",
        .memoryTimeline: "敘事時間軸",
        .memoryStarted: "對話發起",
        .memoryFirstMessage: "第一條訊息",
        .memoryLatestMessage: "最近訊息",
        .memoryElapsed: "已跨時長",
        .modelUsage: "模型用量",
    ...
    private static let english: [Key: String] = [
        ...
        .deleteMessageHint: "This message will be permanently deleted.",
        .confirmDeleteConversation: "This action cannot be undone. Delete this conversation?",
        .rename: "Rename",
        ...
        .onboardingWelcomeBody: "Prism is a narrative analysis Agent powered by DeepSeek. It identifies narrative patterns, tracks emotional changes, and surfaces blindspots.",
        .onboardingPurposeTitle: "What Prism Does",
        .onboardingPurposeBody: "Powered by DeepSeek, Prism helps you separate facts from interpretations, trace emotions, and identify what's unknown in your narrative.",
        ...
        .onboardingDataBody: "Conversations, indexes, and analysis records are stored locally, but model-backed features send the required context and related data to the model API you choose.",
        ...
        .dataPrivacyDesc: "Conversations, indexes, and analysis records are stored locally; model-backed features send the required context and related data to the DeepSeek API.",
        ...
        .loggingHint: "Write run logs to prism.log in the data directory",
        .exportLogs: "Export Logs",
        .exportLogsHint: "Save a copy of prism.log for troubleshooting",
        .validate: "Validate",
        .validating: "Validating…",
        .validationSuccess: "✓ Key is valid",
        .validationFailed: "Key validation failed",
        .validationFailedHint: "You can fix it later in Settings, or continue anyway",
        .memoryTimeline: "Narrative Timeline",
        .memoryStarted: "Conversation started",
        .memoryFirstMessage: "First message",
        .memoryLatestMessage: "Latest message",
        .memoryElapsed: "Elapsed",
