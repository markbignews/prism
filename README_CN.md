...
棱镜是一款**本地优先、尊重隐私**的情感分析 Agent，基于 DeepSeek 大语言模型。它识别叙事模式、追踪情绪变化、发现盲点。

> 本产品系情感分析 Agent，不属于《人工智能拟人化互动服务管理暂行办法》(2026.7.15施行) 所规定的"拟人化互动服务"。不提供持续性情感陪伴。未满14周岁请在监护人陪同下使用。
