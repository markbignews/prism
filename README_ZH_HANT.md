...
稜鏡是一款**本地優先、尊重隱私**的情感分析 Agent，基於 DeepSeek 大語言模型。它識別敘事模式、追蹤情緒變化、發現盲點。

> 本產品係情感分析 Agent，不屬於《人工智能擬人化互動服務管理暫行辦法》(2026.7.15施行) 所規定的"擬人化互動服務"。不提供持續性情感陪伴。未滿14周歲請在監護人陪同下使用。
